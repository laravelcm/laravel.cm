                    ...
                    <div class="sm:inline-flex sm:items-center text-sm text-skin-inverted-muted">
                        <div class="flex items-center">
                            ...
                            <span class="inline-flex mx-1.5 space-x-1">
                                ...
                                <time class="sr-only" datetime="{{ $thread->created_at }}" title="{{ $thread->last_posted_at->format('j M, Y \à H:i') }}">
                    ...
                    @if ($thread->isConversationOld())
                        <x-info-panel class="font-sans">
                            <p class="text-sm text-blue-700">
                                La dernière réponse à ce sujet remonte à plus de six mois.
                                Pensez à ouvrir un nouveau sujet si vous avez une question similaire.
                            </p>
                ...
                @else
                    @guest
                        <p class="text-center py-8 font-sans text-skin-base">
                            ...
                            <a href="{{ route('register') }}" class="text-skin-primary hover:text-skin-primary-hover hover:underline">
                                créer un compte
                            </a> pour participer à cette conversation.
                        </p>
                    @else
