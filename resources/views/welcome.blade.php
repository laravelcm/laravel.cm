                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="https://laravel.com/docs" class="underline text-skin-inverted font-heading">{{ __('Articles') }}</a>
                                </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-skin-light md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
                                    <a href="https://laracasts.com" class="underline text-skin-inverted font-heading">{{ __('Discussions') }}</a>
                                </div>
                            </div>
                        ...
                        <div class="p-6 border-t border-skin-light">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-skin-inverted font-heading">{{ __('Podcasts') }}</div>
                            </div>
                        ...
                        <div class="p-6 border-t border-skin-light dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-skin-inverted font-heading">{{ __('Premium') }}</div>
                            </div>
