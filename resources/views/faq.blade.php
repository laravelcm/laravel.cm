        ...
        <div id="faq-questions" class="text-base flex -mx-2 -mt-4">
            <div class="flex-none px-2 w-full space-y-4 md:hidden">
                ...
                <div class="bg-skin-card p-6 rounded-xl ring-1 ring-inset ring-gray-900/10">
                    ...
                    <div class="prose prose-sm leading-5">
                        <p>
                            Oui! Laravel.cm utilise Markdown X réalisé par <a href="https://twitter.com/tnylea" target="_blank">Tony Lea</a> sur la plateforme
                ...
                <div class="bg-skin-card p-6 rounded-xl ring-1 ring-inset ring-gray-900/10">
                    ...
                    <div class="prose prose-sm leading-5">
                        <p>
                            ...
                            <a href="https://tallstack.dev" target="_blank">TALL Stack</a> qui permet de
            ...
            <div class="flex-none px-2 w-1/2 hidden space-y-4 md:block lg:hidden">
                <div class="bg-skin-card p-6 rounded-xl ring-1 ring-inset ring-gray-900/10">
                    <h3 class="font-semibold text-skin-inverted font-heading mb-2">
                        Qui peut publier sur Laravel.cm ?
                    </h3>
            ...
            <div class="flex-none px-2 w-1/3 hidden space-y-4 lg:block">
                <div class="bg-skin-card p-6 rounded-xl ring-1 ring-inset ring-gray-900/10">
                    <h3 class="font-semibold text-skin-inverted font-heading mb-2">
                        Qui peut publier sur Laravel.cm ?
                    </h3>
            ...
            <div class="flex-none px-2 w-1/3 hidden space-y-4 lg:block">
                ...
                <div class="bg-skin-card p-6 rounded-xl ring-1 ring-inset ring-gray-900/10">
                    ...
                    <div class="prose prose-sm leading-5">
                        <p>
                            Laravel.cm est basé sur le framework Laravel et implémente le
                            <a href="https://tallstack.dev" target="_blank">TALL Stack</a> qui permet de créer
