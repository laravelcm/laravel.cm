<div class="overflow-hidden rounded-md bg-skin-card">
    <div class="p-4">
        <h4 class="text-lg font-medium text-gray-900">Articles les plus visités</h4>
    </div>
    <div class="flex items-center justify-between bg-skin-body px-4 py-3">
        ...
        <span class="text-xs uppercase leading-4 tracking-wider text-gray-700 dark:text-gray-300">Vues</span>
    </div>
