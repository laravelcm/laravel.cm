        ...
        <div>
            ...
            <div class="mt-6 lg:grid lg:grid-cols-5 lg:gap-8">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-6 space-y-8">
                            <div class="grid gap-5 sm:grid-cols-3 sm:gap-6">
                                ...
                                >
                                    <div
                                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-green-50 text-green-800"
                                    >
                                    ...
                                    <div class="ml-3">
                                        <p
                                            class="text-sm font-medium leading-6 text-skin-inverted-muted group-hover:text-green-600"
                                        >
                ...
                <div class="mt-10 lg:col-span-1 lg:mt-0">
                    <h5 class="text-sm font-medium leading-5 text-skin-base">{{ __('Nouveaux membres') }}</h5>
