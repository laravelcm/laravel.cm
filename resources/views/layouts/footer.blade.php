        ...
        <div class="py-12 lg:py-16 lg:grid lg:grid-cols-3 lg:gap-8">
            ...
            <div class="mt-12 lg:mt-0">
                ...
                <div class="mt-4 sm:flex sm:items-center sm:space-x-4">
                    <a href="https://discord.gg/KNp6brbyVD" class="inline-flex items-center px-4 py-2 text-base text-skin-base font-medium bg-skin-body hover:bg-skin-card-muted rounded-md">
                    ...
                    <a href="https://t.me/laravelcameroun" class="inline-flex items-center mt-4 sm:mt-0 px-4 py-2 text-base text-skin-base font-medium bg-skin-body hover:bg-skin-card-muted rounded-md">
