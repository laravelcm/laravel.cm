    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="py-12 lg:py-16 xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-4 xl:col-span-1">
                ...
                <p class="inline-flex items-center flex-wrap text-base text-skin-base font-sans">
            ...
            <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                ...
                <div>
                    ...
                    <div class="mt-4 sm:flex sm:items-center sm:space-x-4">
                        <a href="#" class="inline-flex items-center px-4 py-2 text-base text-skin-base font-medium font-sans bg-skin-body hover:bg-skin-card-muted rounded-md">
