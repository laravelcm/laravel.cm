...
<div class="rounded-lg bg-skin-card px-4 py-6 shadow sm:p-6">
    <article aria-labelledby="question-title-{{ $thread->id }}">
        <div>
            <div class="lg:flex lg:space-x-3">
                ...
                <div class="mt-2 shrink-0 self-center lg:mt-0">
            ...
            <h2 id="question-title-{{ $thread->id }}" class="mt-4 text-base font-medium text-gray-900">
        ...
        <div class="mt-6 flex justify-between space-x-8">
            <div class="flex items-center space-x-4">
                ...
                <p class="inline-flex space-x-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <span class="text-gray-700 dark:text-gray-300">{{ count($thread->replies) }}</span>
                ...
                <p class="inline-flex space-x-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <span class="text-gray-700 dark:text-gray-300">{{ $thread->views_count }}</span>
