...
<div {{ $attributes->twMerge(['class' => 'mt-5 grid gap-4 lg:grid-cols-2']) }}>
    @foreach($channels as $channel)
        <div class="relative rounded-lg transition bg-white duration-200 ease-in-out ring-1 ring-gray-200/70 dark:ring-gray-800 dark:bg-gray-800 px-4 py-3 hover:ring-gray-200 dark:hover:ring-white/20 lg:px-5">
