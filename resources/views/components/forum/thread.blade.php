...
<article class="rounded-xl p-4 bg-white ring-1 ring-gray-200 transition duration-200 ease-in-out overflow-hidden dark:bg-gray-800 dark:ring-white/10 lg:p-5" aria-labelledby="{{ $thread->slug }}">
    ...
    <div class="sm:flex sm:items-start sm:gap-4">
        ...
        @if ($thread->isSolved())
            <x-link
                ...
                class="inline-flex items-center mt-2 rounded-xl gap-1 px-2 py-0.5 font-medium bg-primary-50 ring-1 ring-primary-200 text-primary-700 dark:bg-primary-800/20 dark:text-primary-500 dark:ring-primary-800 sm:mt-0"
            >
