    ...
    <div class="space-y-1 pb-8">
        ...
        >
            ...
            >
                ...
                <path
                    clip-rule="evenodd"
                    d="M3.61 12c0 6.937 2.098 9.25 8.391 9.25 6.294 0 8.391-2.313 8.391-9.25 0-6.937-2.097-9.25-8.391-9.25C5.708 2.75 3.61 5.063 3.61 12z"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                />
        ...
        >
            ...
            >
                <path
                    d="M6.98 4.601V17.22M2.9 8.7s2.169-4.1 4.078-4.1c1.908 0 4.078 4.1 4.078 4.1M16.906 19.428V6.81M20.985 15.329s-2.17 4.1-4.078 4.1c-1.908 0-4.078-4.1-4.078-4.1"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                />
...
@else
    <div class="mx-auto mt-10 max-w-lg lg:hidden">
        <nav class="relative z-0 flex divide-x divide-skin-base rounded-lg shadow" aria-label="Tabs">
            ...
            >
                ...
                <span
                    aria-hidden="true"
                    class="{{ $selectedSortBy === 'trending' ? 'bg-skin-primary' : 'bg-transparent' }} absolute inset-x-0 bottom-0 h-0.5"
                ></span>
            </button>
        </nav>
    </div>
