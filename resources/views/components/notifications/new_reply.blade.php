            ...
            <div class="whitespace-nowrap text-sm leading-5 text-skin-base">
                <div class="flex items-center space-x-3">
                    <span class="p-2 flex items-center justify-center rounded-full bg-skin-card-gray">
                        <x-untitledui-message-circle class="w-5 h-5 text-skin-base"/>
                    </span>
                    <div>
                        <p class="text-base leading-6">
                            Une nouvelle réponse a été ajoutée au sujet
                            <a href="{{ route('replyable', [$data['replyable_id'], $data['replyable_type']]) }}" class="text-skin-primary hover:text-skin-primary-hover">
            ...
            <div class="whitespace-nowrap text-sm leading-5 text-skin-base text-right">
                <div class="flex justify-end -mt-3">
                    <button
                        ...
                        class="inline-flex items-center justify-center p-2 bg-green-500 bg-opacity-10 text-green-600 text-sm leading-5 rounded-full focus:outline-none transform hover:scale-125 transition-all"
                    >
