<div {{ $attributes->twMerge(['class' => 'relative isolate overflow-hidden flex items-center justify-center mb-6 shadow-md rounded-xl aspect-[2/1] w-full sm:mb-0 xl:mb-6 bg-gradient-to-b']) }}>
