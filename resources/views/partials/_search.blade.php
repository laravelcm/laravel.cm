<div class="group w-full max-w-lg cursor-pointer lg:max-w-xs" @click="$dispatch('toggle-spotlight')">
    ...
    <div class="relative">
        <div class="w-full rounded-lg border border-gray-200 bg-white py-2 pl-4 pr-12 text-sm leading-5 text-gray-400 group-hover:bg-gray-50 dark:text-gray-500 dark:group-hover:bg-gray-800/10 dark:border-gray-700">
