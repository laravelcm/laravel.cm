...
<div class="fixed inset-0 z-20 sm:z-10 sm:absolute sm:inset-auto transition-all ease-linear duration-150 {{ $rootClass }}"
    ...
    <div class="flex items-end justify-center min-h-screen sm:min-h-max sm:items-start">
        <div class="fixed inset-0 bg-skin-muted bg-opacity-60 transition-opacity sm:hidden="
             x-show="popover"
        ...
        <div
            {{ $attributes->class([
                'w-full rounded-t-md sm:rounded-md border border-skin-base bg-skin-card shadow-lg',
