                ...
                @else
                    @if(method_exists($paginator,'getCursorName'))
                        <button
                            ...
                            class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-skin-inverted bg-skin-card border border-skin-input leading-5 rounded-md hover:text-skin-base focus:outline-none focus:shadow-outline-green focus:border-green-300 active:bg-skin-footer transition ease-in-out duration-150"
                        >
                            {!! __('pagination.previous') !!}
                        </button>
                    @else
