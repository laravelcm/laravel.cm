            ...
            <div class="lg:col-span-7 space-y-4">
                ...
                <div class="space-y-10">
                    ...
                    <div class="pt-12 border-t border-skin-base">
                        <h4 class="text-skin-inverted text-lg lg:text-xl font-medium font-heading">
                            Sponsors
                        </h4>
                        ...
                        @auth
                            <div class="p-4 flex items-center border-t border-skin-base bg-skin-card-muted">
                                ...
                                <p class="flex-1 ml-4 text-sm leading-5 text-skin-base">
                                    Voici le badge sur votre avatar que vous obtiendrez et qui indique que vous êtes un sponsor de @laravelcm.
                                </p>
                            </div>
                        @endauth
                    </div>
