                        ...
                        <div class="min-w-0 flex-1">
                            <div class="focus:outline-none">
                                ...
                                <div class="mt-2 flex items-center space-x-4">
                                    <a href="https://twitter.com/laravelcm" class="text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:text-gray-400">
                                        <span class="sr-only">Twitter</span>
                                        <x-icon.twitter class="size-5" />
                                    </a>

                                    <a href="https://facebook.com/laravelcm" class="text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:text-gray-400">
                                        <span class="sr-only">Facebook</span>
                                        <x-icon.facebook class="size-5" />
                                    </a>

                                    <a href="https://www.linkedin.com/company/laravel-cameroun" class="text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:text-gray-400">
                                        <span class="sr-only">LinkedIn</span>
                                        <x-icon.linkedin class="size-5" />
                                    </a>

                                    <a href="https://github.com/laravelcm" class="text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:text-gray-400">
                                        <span class="sr-only">Github</span>
                                        <x-icon.github class="size-5" />
                                    </a>

                                    <a href="https://www.youtube.com/channel/UCbQPQ8q31uQmuKtyRnATLSw" class="text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:text-gray-400">
