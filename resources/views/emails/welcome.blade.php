@component('mail::message')
    ...
    @component('mail::subcopy')
        [Créer un article :]({{ route('dashboard.index') }}) partager vos connaissances en programmation avec plus de
    ...
    @component('mail::subcopy')
        [Démarrer une discussion :]({{ route('dashboard.discussions') }}) vous êtes du style bavard et vous avez des
