@component('mail::message')
    ...
    touche davantage de personnes et de développeurs de façon simple et rapide. [![Alt
    text](https://media.giphy.com/media/Sg4DwEJrCpGIU/giphy-downsized-large.gif)](https://laravel.cm/discussions/bienvenu-sur-laravel-cameroun)
    ...
    @component('mail::subcopy')
            [Créer un thread :]({{ route('forum.new') }}) vous rencontrez des soucis dans votre code ou votre projet 🤔
