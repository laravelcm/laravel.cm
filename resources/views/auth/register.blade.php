...
@section('body')
    ...
    <div class="w-full mx-auto flex items-center justify-between py-16 sm:max-w-4xl">
        ...
        <div class="mx-auto max-w-md lg:mx-0">
            ...
            <div class="mt-8">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div class="space-y-3">
                        ...
                        <x-password id="password" name="password" autocomplete="current-password" required placeholder="{{ __('Mot de passe (min. 8 carateres)') }}" aria-label="{{ __('Mot de passe') }}" />
                    </div>
            ...
            <div class="mt-8">
                ...
                <div class="mt-6 grid grid-cols-2 gap-2">
                    <div>
                        <a href="#" class="w-full inline-flex justify-center py-2 px-4 border border-skin rounded-md shadow-sm bg-skin-button text-sm font-normal text-skin-base hover:bg-skin-button-hover">
