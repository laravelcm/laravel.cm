            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="rounded-md shadow-sm space-y-4">
                    <div>
                        ...
                        <x-email id="email-address" name="email" autocomplete="email" required placeholder="Adresse E-mail" />
                    </div>
                    <div>
                        <label for="password" class="sr-only">Mot de passe</label>
                        <x-password id="password" name="password" autocomplete="current-password" required placeholder="Mot de passe" />
                    </div>
                </div>
