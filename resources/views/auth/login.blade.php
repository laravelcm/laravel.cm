<x-app-layout title="Se connecter">
    <div class="flex min-h-full items-center justify-center py-16 sm:py-24">
        <div class="w-full max-w-md space-y-8">
            <div>
                <h2 class="text-center font-heading text-3xl font-extrabold text-skin-inverted">
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        />
                        <label for="remember_me" class="ml-2 block cursor-pointer text-sm font-normal text-skin-base">
                            Se souvenir de moi
                        </label>
                    </div>
