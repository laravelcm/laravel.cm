                ...
                <x-sticky-content class="space-y-6 divide-y divide-skin-base">
                    ...
                    @if ($next || $previous)
                        <div class="space-y-6 pt-6">
                            @if ($next)
                                <div>
                                    <h2 class="text-xs font-medium uppercase leading-5 tracking-wide text-gray-500 dark:text-gray-400">
                                        Article suivant
                                    </h2>
                                    <a
                                    ...
                                    >
                                        ...
                                        />
                                        <span
                                            class="line-clamp-2 text-sm font-medium leading-4 text-gray-900 hover:text-primary-600-hover"
                                        >
                                            {{ $next->title }}
                                        </span>
                                    </a>
            ...
            <div class="lg:col-span-5">
                ...
                <div class="py-6">
                    ...
                    <div class="mt-4 space-y-4 sm:flex sm:items-center sm:space-x-4 sm:space-y-0">
                        ...
                        >
                            <x-icon.twitter class="mr-1.5 size-5" />
                            Twitter
                        </a>
                        <a
                            ...
                            class="inline-flex items-center rounded-md border border-skin-base bg-skin-button px-4 py-2 text-sm font-normal leading-5 text-gray-500 dark:text-gray-400 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-body"
                        >
                            <x-icon.facebook class="mr-1.5 size-5" />
                            Facebook
                        </a>
                        <a
                            ...
                            class="inline-flex items-center rounded-md border border-skin-base bg-skin-button px-4 py-2 text-sm font-normal leading-5 text-gray-500 dark:text-gray-400 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-body"
                        >
                            <x-icon.linkedin class="mr-1.5 size-5" />
                            LinkedIn
                        </a>
                    </div>
                </div>
                        ...
                        <div class="relative flex justify-center">
                            <span class="relative z-0 inline-flex -space-x-px rounded-md shadow-sm">
                                <a
                                    ...
                                    class="relative inline-flex items-center rounded-l-md border border-skin-base bg-skin-card px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-skin-card-muted focus:z-10 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 focus:ring-offset-body"
                                >
                                ...
                                @if ($article->isNotApproved())
                                    @hasanyrole('admin|moderator')
                                        ...
                                        >
                                            ...
                                            <x-untitledui-check-verified-02 class="size-5" />
                                        </button>
                                    @endhasanyrole
                                @endif
                                ...
                                <button
                                    ...
                                    type="button"
                                    class="relative inline-flex items-center rounded-r-md border border-skin-base bg-skin-card px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-skin-card-muted focus:z-10 focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500 focus:ring-offset-body"
                                >
                                    <span class="sr-only">Supprimer</span>
                                    <x-untitledui-trash-03 class="size-5" />
                                </button>
                            </span>
                        </div>
                    </div>
