                ...
                <x-sticky-content class="divide-y divide-skin-base space-y-6">
                    ...
                    @if($next || $previous)
                        <div class="pt-6 space-y-6">
                            @if($next)
                                <div>
                                    <h2 class="text-xs leading-5 font-medium tracking-wide uppercase text-skin-base">
                                        Article suivant
                                    </h2>
                                    <a href="{{ route('articles.show', $next) }}" class="mt-3 flex items-start space-x-2">
                                        <img class="h-8 w-8 object-cover shadow-lg rounded-md"
                                             ...
                                             alt="{{ $next->slug }}">
                                        <span class="text-sm font-medium leading-4 text-skin-inverted hover:text-skin-primary-hover line-clamp-2">
                                            {{ $next->title }}
                                        </span>
                                    </a>
                                </div>
            ...
            <div class="lg:col-span-5">
                ...
                <div class="mt-6 pt-5 border-t border-skin-base sm:hidden">
                    <div class="space-y-4">
                        ...
                        @if($user->bio)
                            <p class="text-sm text-skin-base leading-5">
                                {{ $user->bio }}
                            </p>
                        @endif
                        <div class="flex space-x-3">
                ...
                <x-sticky-content class="space-y-10">
                    ...
                    @if($article->showToc())
                        <div class="bg-skin-card px-4 py-6 rounded-lg shadow-lg">
                            <h4 class="text-sm text-skin-inverted font-semibold leading-tight tracking-widest uppercase">
                                Table des matières
                            </h4>
    ...
    @if($article->showToc())
        <div x-data="{ openTOC: false }" class="relative lg:hidden">
            <button
                ...
                <span class="hidden ml-1 text-sm font-semibold uppercase md:block">
                    Sommaire
                </span>
            </button>
