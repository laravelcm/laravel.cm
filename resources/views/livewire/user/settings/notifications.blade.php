<div class="pb-20">
    <div class="flex items-center">
        <div class="flex-1">
            <h3 class="text-lg font-medium leading-6 text-skin-inverted">Gérez vos notifications</h3>
            <p class="mt-1 max-w-4xl text-sm font-normal text-skin-base">
        ...
        <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-x-5 lg:gap-y-6">
            @forelse ($subscriptions as $subscription)
                <div class="flex flex-col justify-between rounded-md bg-skin-card-gray p-4 sm:p-5">
                    <p class="font-sans text-base leading-6 text-skin-inverted">
                        <a
                            href="{{ route('subscriptions.redirect', [$subscription->subscribeable_id, $subscription->subscribeable_type]) }}"
                            class="font-medium text-skin-inverted hover:text-skin-primary-hover"
                        >
            ...
            @empty
                <div class="grid max-w-4xl sm:col-span-2 lg:col-span-3">
                    <div class="flex rounded-md bg-skin-card-gray px-4 py-3">
                        ...
                        <div class="ml-3 flex-1 font-normal text-skin-base">
                            ...
                            <span class="font-medium text-skin-inverted">"S'abonner"</span>
