        ...
        <div class="mt-4 pt-5 border-t border-skin-base">
            ...
            <div class="mt-2 flex items-center space-x-5">
                <div class="flex items-center gap-x-3">
                    <input id="company" name="type" wire:model="type" value="company" type="radio" class="h-4 w-4 border-skin-input text-primary-600 focus:ring-primary-600">
                    <label for="company" class="block text-sm font-medium leading-6 text-skin-inverted">{{ __('Entreprise') }}</label>
                </div>
                <div class="flex items-center gap-x-3">
                    <input id="developer" name="type" wire:model="type" value="developer" type="radio" class="h-4 w-4 border-skin-input text-primary-600 focus:ring-primary-600">
