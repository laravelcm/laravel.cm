        ...
        <div class="mx-auto max-w-4xl px-4 lg:max-w-7xl xl:grid xl:grid-flow-col-dense xl:grid-cols-2 xl:gap-x-8">
            <div class="relative pb-64 pt-12 sm:pb-64 sm:pt-24 xl:col-start-1 xl:pb-24">
                ...
                <div class="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2">
                    <p>
                        <span class="block font-heading proportional-nums slashed-zero text-2xl text-white">600+</span>
                    ...
                    <p>
                        <span class="block font-heading proportional-nums slashed-zero text-2xl text-white">50K+</span>
                        <span class="mt-1 block text-base text-gray-400">
                    ...
                    <p>
                        <span class="block font-heading proportional-nums slashed-zero text-2xl text-white">25%</span>
                        <span class="mt-1 block text-base text-gray-400">
                    ...
                    <p>
                        <span class="block font-heading proportional-nums slashed-zero text-2xl text-white">10K+</span>
                        <span class="mt-1 block text-base text-gray-400">
