    ...
    <div x-data class="space-y-5">
        ...
        <div class="space-y-4">
            @forelse ($this->articles as $article)
                <div wire:key="{{ $article->id }}" class="rounded-xl p-4 bg-white transition duration-200 ease-in-out ring-1 ring-gray-200/50 dark:bg-gray-800 dark:ring-white/10 dark:hover:bg-white/10">
                    ...
                    <x-link :href="route('articles.show', $article->slug)" class="mt-2 block">
                        <h3 class="font-heading text-lg font-semibold text-gray-900 hover:text-primary-600 dark:text-white dark:hover:text-primary-500">
                            {{ $article->title }}
                        </h3>
