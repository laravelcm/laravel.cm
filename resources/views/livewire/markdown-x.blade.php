    ...
    <div x-data="markdown()" x-ref="markdownX" data-key="{{ $key }}" id="markdown-{{ $key }}" class="relative w-full" x-init="init()">
        ...
        <div class="@if(isset($style['toolbar'])){{ $style['toolbar'] }}@else{{ 'relative flex items-center justify-between w-full h-12 overflow-x-hidden bg-skin-card sm:h-10' }}@endif">
            <div class="flex items-center h-12 sm:h-10">
                <div class="flex items-center h-full px-4 text-sm font-medium text-skin-base cursor-pointer hover:bg-skin-card-muted sm:text-base" @click="section = 'write'" x-bind:class="{ 'text-green-500 border-b border-green-500' : section === 'write' }">
                    <x-heroicon-o-pencil class="w-4 h-4 mr-2" />
                    <span>Saisi</span>
                </div>
                <div wire:click="updateContentPreview()" class="flex items-center h-full px-4 text-sm font-medium text-skin-base cursor-pointer hover:bg-skin-card-muted sm:text-base" @click="section = 'preview'" x-bind:class="{ 'text-green-500 border-b border-green-500' : section === 'preview' }">
                    <x-heroicon-o-eye class="w-4 h-4 mr-2" />
                    <span>Preview</span>
                </div>
                <div class="flex items-center h-full px-4 text-sm font-medium text-skin-base cursor-pointer hover:bg-skin-card-muted sm:text-base" @click="section = 'help'" x-bind:class="{ 'text-green-500 border-b border-green-500' : section === 'help' }">
            ...
            <div class="hidden relative sm:flex items-center h-full px-4 text-sm font-medium text-skin-base cursor-pointer hover:bg-skin-card-muted sm:text-base">
        ...
        <div class="relative z-40" x-show="section === 'write'">
            ...
            <div x-ref="editorModal" x-show="popup" x-ref="popup" x-on:keydown.escape="cancelModal(); popup=false" x-on:click.away="popup=false" wire:ignore :class="{ 'translate-y-2 scale-100 transition-transform duration-100 ease-in-out': popup, 'translate-y-0 scale-95': !popup,  'max-w-sm' : popupType !== 'code', 'max-w-4xl pr-10' : popupType === 'code' }" class="absolute z-40 w-full max-w-sm transform rounded-lg shadow-sm" x-cloak>
                <div class="absolute left-0 w-4 h-4 -mt-2 ml-3.5 transform rotate-45 bg-skin-card border-t border-l border-skin-input rounded-tl-sm"></div>
                <div class="overflow-hidden border border-skin-input rounded-lg">
        ...
        <div x-show="section === 'help'" class="@if(isset($style['help'])){{ $style['help'] }}@else{{ 'h-full bg-skin-card min-h-screen px-5 pt-10 relative z-30 prose md:prose-sm lg:prose-lg max-w-none' }}@endif" x-cloak>
            ...
            <h3>Code</h3>
            <p><span class="mr-2">Inline Code</span><br><span class="p-1 font-mono text-green-500 bg-green-100 rounded-md">`backtick`</span><span class="block mt-2 mr-2">Code Block</span><span class="block p-1 font-mono text-green-600 bg-green-100">```<br>Three back ticks and then enter your code blocks here.<br>```</span></p>
            <hr>
        ...
        window.markdown = function() {
            return {
                ...
                createDropDownElement () {
                    ...
                    marker.className = 'absolute z-50 block w-auto overflow-hidden transition-all duration-100 ease-in-out transform scale-95 translate-x-0 bg-skin-card border border-skin-input rounded-md shadow-xl translate-y-7 whitespace-wrap';
                    return marker;
                },
                isNormalInteger (str) {
                    str = str.trim();
                ...
                setModalHTML (suggestion) {
                    ...
                    modalSuggestionHTML["link"] = `<label for="text" class="block mb-1.5 text-sm font-medium leading-5 text-skin-menu sm:mt-px">
                            Link Text
                        </label>
                    ...
                    modalSuggestionHTML["code"] = `<label for="text" class="block mb-1.5 text-sm font-medium leading-5 text-skin-menu sm:mt-px">
                            Code
                        </label>
                    ...
                    modalSuggestionHTML["giphy"] = `<label for="text" class="block mb-1.5 text-sm font-medium leading-5 text-skin-menu sm:mt-px">
                    ...
                    modalSuggestionHTML["codepen"] = `<label for="text" class="block mb-1.5 text-sm font-medium leading-5 text-skin-menu sm:mt-px">
                            Codepen URL
                        </label>
                    ...
                    modalSuggestionHTML["codesandbox"] = `<label for="text" class="block mb-1.5 text-sm font-medium leading-5 text-skin-menu sm:mt-px">
                            Codesandbox URL
                        </label>
                    ...
                    modalSuggestionHTML["youtube"] = `<label for="text" class="block mb-1.5 text-sm font-medium leading-5 text-skin-menu sm:mt-px">
                            Youtube URL
                        </label>
                    ...
                    modalSuggestionHTML["buy_me_a_coffee"] = `<label for="text" class="block mb-1.5 text-sm font-medium leading-5 text-skin-menu sm:mt-px">
