<x-app-layout :title="__('pages/about.title')">
    <x-container class="px-0 line-x">
        <header class="px-4 py-24 lg:grid lg:grid-cols-2 lg:gap-x-12 lg:pt-32">
            <div class="sm:text-center md:mx-auto md:max-w-2xl lg:mx-0 lg:text-left">
                <p class="text-sm font-medium text-primary-600 dark:text-primary-500 sm:text-base lg:text-lg">
                    {{ __('pages/about.title') }}
                </p>
                <h1 class="text-gray-900 dark:text-white mt-2 text-2xl font-extrabold font-heading tracking-tight sm:text-3xl xl:text-4xl">
        ...
        <section class="bg-dotted p-2 after:border-0 border-y border-dotted border-line">
            <dl class="rounded-xl bg-white dark:bg-white/10 ring-1 ring-gray-200 dark:ring-white/20 sm:grid sm:grid-cols-3">
                <div class="flex flex-col p-6 text-center sm:p-10">
                    <dt class="order-2 mt-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">
                        {{ __('pages/about.stats.member_discord') }}
                    </dt>
                    <dd class="order-1 font-heading proportional-nums slashed-zero text-5xl font-extrabold text-primary-600 dark:text-primary-500">
                        +300
                    </dd>
                </div>
                <div class="flex flex-col p-6 text-center sm:p-10">
        ...
        <div class="px-4 mx-auto max-w-3xl py-8 sm:py-10 lg:max-w-none lg:py-12 xl:pb-20">
            <p class="text-sm font-medium text-primary-600 sm:text-base">
                {{ __('pages/about.history') }}
            </p>
            <h2 class="mt-1 font-heading text-gray-900 dark:text-white text-2xl font-bold tracking-tight sm:text-3xl">
                {{ __('pages/about.history_part_one') }}
            </h2>

            <div class="prose prose-lg prose-emerald mt-5 text-gray-500 dark:text-gray-400 dark:prose-invert lg:max-w-none">
                <div class="lg:grid lg:grid-cols-2 lg:gap-x-12">
                    <div>
                        <p>{{ __('pages/about.first_description') }}</p>
                        <p>{{ __('pages/about.second_description') }}</p>
                        <ul class="font-normal">
                            ...
                            <li>
                                ...
                                <span class="font-medium text-primary-600 dark:text-primary-500">Kerawa Cameroun</span>
                                {{ __('pages/about.list.two.description') }}
                            </li>
                            <li>
                                {{ __('pages/about.list.three.title') }}
                                <span class="font-medium text-primary-600 dark:text-primary-500">John's Corporation</span>
                        ...
                        <p>{{ __('pages/about.list.paragraph_one') }}</p>
                    </div>
            ...
            <div class="mt-12 border-t border-line pt-12 sm:mt-14 sm:pt-14">
                                ...
                                <li>
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $profile['title'] }}</p>
                                        </div>
